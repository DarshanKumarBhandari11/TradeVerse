        ...
        <div className="container">
            ...
            <div className="row p-5 mt-5 border-top text-muted" style={{ lineHeight: "1.8", fontSize: "1.1em" }}>
                <div className="col-6 p-5">
                    <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company <b>TradeVerse</b>, a combination of Trade and "Verse", derived from universe, symbolizing a limitless and interconnected world of trading.</p>
